-- ============================================================
-- 019_vector_dimension_3072.sql
-- Adjust pgvector columns to 3072 dimensions for Google Gemini
-- ============================================================
...
-- Recreate columns with vector(3072)
...
ALTER TABLE public.contact_memories ADD COLUMN embedding vector(3072);

-- Recreate HNSW indexes for 3072 dimensions
...
-- Recreate RPC functions to match vector(3072) parameters
